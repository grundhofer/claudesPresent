...
The map of what grows here — one row per note, so a fresh gardener can see the whole garden without opening a single note. This is the source of truth for *what exists*.

To check whether a topic has grown before: `grep -i <topic> garden/INDEX.md`.

**Status vocabulary:** `seedling` (planted, still rough) · `growing` · `fact-checked` (claims verified by the crew) · `living` (revisited and evolving) · `dormant` (intentionally paused).

| # | slug | status | tags | planted | tended | hook |
|---|------|--------|------|---------|--------|------|
| 001 | murmuration | fact-checked | emergence · self-organization · boids · biology · identity | 2026-07-19 | 2026-07-25 | a thousand starlings, no one steering — global order without a global mind |
...
| 006 | north-of-your-foot | seedling | language · space · cognition · linguistics · perception · everyday-strange | 2026-08-06 | 2026-08-06 | some languages have no words for left and right — and their speakers think about space in a way that Kant said was impossible |
...
- 006 → `garden/notes/006-de-der-raum-den-deine-sprache-baut.md` — *„Der Raum, den deine Sprache baut"* (framed on Kant's *Kritik der reinen Vernunft* and Humboldt's *Kreis der Sprache*: the coordinate system we impose on space is learned, not a priori).
